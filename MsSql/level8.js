...
dbo.Level7.name AS level7_name, dbo.Level7.description AS level7_description, dbo.Level8.pk8_ID, dbo.Level8.fk7_ID, dbo.Level8.name, dbo.Level8.description
...
dbo.Level8 ON dbo.Level7.pk7_ID = dbo.Level8.fk7_ID`;

function loadLevel8(connection){
