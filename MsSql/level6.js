...
dbo.Level4.name AS level4_name, dbo.Level4.description AS level4_description, dbo.Level5.pk5_ID, dbo.Level5.fk4_ID, dbo.Level5.name AS level5_name, dbo.Level5.description AS level5_description, dbo.Level6.pk6_ID, dbo.Level6.fk5_ID, dbo.Level6.name, dbo.Level6.description
...
dbo.Level6 ON dbo.Level5.pk5_ID = dbo.Level6.fk5_ID`;

function loadLevel6(connection){
